                ...
                Expanded(
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      bool _isMine = controller.chatList[index].userKey ==
                          userModel.userKey;
                      // return ListTile(
                      //   dense: true,
                      ...
                      return Chat(
                        ...
                        chatModel: controller
                            .chatList[index], //chatNotifier.chatList[index],
                      );
                    },
                    ...
                    separatorBuilder: (context, index) {
                      if (DateFormat('yyyy-MM-dd')
                          ...
                          DateFormat('yyyy-MM-dd').format(
                              controller.chatList[index + 1].createdDate)) {
                        ...
                        return Center(
                          child: Padding(
                            ...
                            child: Text(
                              DateFormat('yyyy-MM-dd').format(
                                  controller.chatList[index].createdDate),
                            ),
                          ),
                        );
                      }
                    ...
                    itemCount: controller
                        .chatList.length, //chatNotifier.chatList.length,
                  ),
                ),
          ...
          IconButton(
            onPressed: () async {
              ChatModel2 chatModel = ChatModel2(
                ...
                createdDate:
                    DateTime.now(), // addNewChat->toJson 에서 toUtc() 재처리함.
              );
