import 'package:kkukku/src/models/item_model.dart';
...
>>>>>>> f26f9d12d89efe48f2d584b8ca549dfcd45036ac
          ...
          _buildMarkerWidget(Offset(0, _size.height - 160),
              color: Colors.black87),
          _buildMarkerWidget(Offset(_size.width - 20, _size.height - 160),
              color: Colors.black87),
        ];
        ...
        return FutureBuilder<List<ItemModel2>>(
            future: ItemService()
                .getNearByItems(widget._userModel.userKey, middleLatLngOnMap),
            builder: (context, snapshot) {
              ...
              if (snapshot.hasData) {
                for (var item in snapshot.data!) {
                  ...
                  nearByItems
                      .add(_buildImgWidget(offset, item, middleLatLngOnMap));
                }
              }
                ...
                children: [
                  GestureDetector(
                    ...
                    onScaleUpdate: (details) =>
                        _scaleUpdate(details, transformer),
                    child: TileLayer(
                      // Map TileLayer
